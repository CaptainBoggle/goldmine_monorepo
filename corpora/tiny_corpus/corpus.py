"""
Parser for the tiny_corpus (PhenotypeCR evaluation corpus, tiny subset for fast testing).
...
class TinyCorpusParser(CorpusParser):
            ...
            if doc_dir.is_dir():
                ...
                if lwit_xml.exists():
                    try:
                        ...
                        continue
        print(f"Successfully parsed {len(documents)} documents from tiny_corpus")
        return documents
